...
public class VideoGameRestController {
    ...
    @PutMapping("/videoGames/update/{videoGameId}")
    ...
    @DeleteMapping("/videoGames/delete/{videoGameId}")
    ...
    @GetMapping("/videoGames/findOne/{videoGameId}")
    ...
    @GetMapping("/videoGames/find/title")
    ...
    @GetMapping("/videoGames/find/manufacturer")
    ...
    @GetMapping("/videoGames/find/price-tag")
    ...
    @GetMapping("/videoGames/find/price-range")
