...
public class UserRestController {
    ...
    @PostMapping("/users/{userId}/board-games/add/{boardGameId}")
    public ResponseEntity<BoardGameDTO> addBoardGameToUser(@PathVariable("userId") Long userId,
    ...
    @DeleteMapping("users/{userId}/board-games/delete")
    ...
    @PostMapping("/users/{userId}/video-games/add/{videoGameId}")
    public ResponseEntity<VideoGameDTO> addVideoGameToUser(@PathVariable("userId") Long userId,
